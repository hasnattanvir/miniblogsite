            ...
            <nav class="site-navigation" role="navigation">
              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block mb-0">
                @foreach ($categories as $item)
                  <li><a href="{{route('website.category',['slug'=> $item->slug])}}">{{$item->name}}</a></li>
                @endforeach
        ...
        <div class="row mb-5">
          ...
          <div class="col-md-4">
            ...
            <div>
              ...
              <p>
                <a href="{{$settings->facebook}}" target="_blank"><span class="icon-facebook pt-2 pr-2 pb-2 pl-0"></span></a>
