                 ...
                 <div class="sidebar-box">
                     ...
                     <div class="post-entry-sidebar">
                         <ul>
                             ...
                             <li>
                                 <a href="">
                                     <img src="{{asset($item->image)}}" alt="Image placeholder" class="mr-4">
                                     <div class="text">
                                         <h4>{{$item->title}}</h4>
                                         <div class="post-meta">
     ...
     <div class="container">
         ...
         <div class="row align-items-stretch retro-layout">
             ...
             <div class="col-md-5 order-md-2">
                 @foreach ($relatedpostfirst as $item)
             ...
             <div class="col-md-7">
                 @foreach ($relatedpostlast as $item)
                 ...
                 <div class="two-col d-block justify-content-between d-md-flex">
                     @foreach ($relatedpostmid as $item)
...
<script>
    ...
    */
    ...
    s.src = 'https://mini-blog-tanvir.disqus.com/embed.js';
    s.setAttribute('data-timestamp', +new Date());
    (d.head || d.body).appendChild(s);
    })();
</script>
<noscript>Please enable JavaScript to view the <a href="https://disqus.com/?ref_noscript">comments powered by Disqus.</a></noscript>
<script id="dsq-count-scr" src="//mini-blog-tanvir.disqus.com/count.js" async></script>
 @endsection
